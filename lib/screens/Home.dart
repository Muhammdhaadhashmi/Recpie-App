...
import 'package:recpieapp/screens/recpie.dart';

import '../consents/appbar.dart';
import '../consents/color.dart';
...
class _HomeState extends State<Home> {
  ...
  List food = [
    ['burger', 'omlaite', 'grilled wings', 'Grilled ribs'],
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(
                                      'images/${categoryname[index]}${index}.jpg'),
                                  fit: BoxFit.cover,
                                ),
                                borderRadius: BorderRadius.circular(20),
                              ),
